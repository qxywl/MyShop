...
public class ProductInfoAuthDaoImpl extends BaseDao  implements ProductInfoAuthDao
{
    ...
    @Override
    public List<ProductInfoAuthModel> getAllInfoAthByOne() throws Exception {
        List<ProductInfoAuthModel> list = null;
        list = getSqlSession().selectList(getNameSpace()+".getAllInfoAthByOne");
        return list;
    }
}
