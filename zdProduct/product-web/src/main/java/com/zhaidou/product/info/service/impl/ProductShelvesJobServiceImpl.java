...
import com.zhaidou.product.info.dao.ProductShelvesJobDao;
import com.zhaidou.product.info.model.ProductShelvesJobModel;
import com.zhaidou.product.info.service.ProductShelvesJobService;
...
public class ProductShelvesJobServiceImpl implements ProductShelvesJobService
{
    ...
    public List<ProductShelvesJobModel> getProductShelvesJob(ProductShelvesJobModel productShelvesJobModel, Page page)throws Exception
    {
        ...
        long count = productShelvesJobDao.countListPage(productShelvesJobModel);
