...
<form method="POST" action="${contextPath}/sale-category/add" enctype="multipart/form-data" onsubmit="return iframeCallback(this, dialogReloadNavTab);">
    <div class="pageFormContent" layoutH="58">
        ...
        <p>
        	<label>排序值</label>
        	<input type="text" name="sortNumber" class="validate[custom[integer]]"/><span style="color: red"></span>
