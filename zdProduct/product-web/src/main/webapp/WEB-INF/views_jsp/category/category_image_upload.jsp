...
function uploadBack(data){
    ...
    $('#categoryLogoId').val(data.message);
...
<form method="post" action="${contextPath}${frmSubmitUrl}" enctype="multipart/form-data" onsubmit="return iframeCallback(this, uploadBack)" >
