...
<form method="post" action="${contextPath}/sale-category/product/uploadExcel" enctype="multipart/form-data"  onsubmit="return iframeCallback(this, closeDialogReloadNavTab)" >
    <div class="pageFormContent" layouth="56">
		<p>&nbsp;</p>
    	<input type="hidden" name="categoryCode" value="${saleCategory.categoryCode }" />
    	<input type="hidden" name="id" value="${saleCategory.id }" />
