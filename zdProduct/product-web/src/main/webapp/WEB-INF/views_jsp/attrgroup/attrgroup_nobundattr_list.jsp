...
<script type="text/javascript">
	...
	function back()
	{
		$.pdialog.reload("${contextPath}/attrgroup/to_nobundList/${attrGroupId}");
	}
</script>

<div class="pageContent" >
<cas:paginationForm action="${contextPath}/attrgroup/to_nobundList/${attrGroupId}" page="${page}">
    <input type="hidden" name="domainName" value="${domainName}"/>
</cas:paginationForm> 

 <form id="test"method="post" action="${contextPath}/attrgroup/to_nobundList/${attrGroupId}" onsubmit="return dialogSearch(this)">
    ...
    <div class="panelBar">
        <ul class="toolBar">
          <li><a class="add"  href="${contextPath}/attrgroup/addRelation/${groupId}" callback="back" title="确认要关联这些属性?" rel="addIds" targetType ="dialog" target="selectedTodo" ><span>关联属性项</span></a></li>
          <li><a class="icon" id="scanValue" target="dialog" rel="attrValueDialog" mask="true" width="900" height="450" href="${contextPath}/attrgroup/to_listAttrValue/{slt_uid}"><span>查看属性值</span></a></li>
        </ul>
    </div>
        ...
        <tbody>
            <c:if test="${productAttrModelList!=null}">
	            ...
	            <tr target="slt_uid" rel="${attrModel.attrId}" style="text-align: center;">
	                <td><input name="addIds" value="${attrModel.attrId}" type="checkbox" class="checkboxCtrl"></td>
