...
<form method="post" action="${contextPath}/info/product/upload_excel_update" enctype="multipart/form-data"  onsubmit="return iframeCallback(this, dialogReloadNavTab)" >
   	<div id="warp">
    ...
    <div class="main_warpdiv">
        ...
        <div class="exel">
            <div>
            	<a id="btnDownloadUpdate" href="doc/dwz-team.xls" target="dwzExport" targetType="dialog"><input type="button"  onclick="downExcel();" value="下载编辑模板" class="fontColor"/></a>
                <!-- <a id="btnDownloadUpdate" href=""><input type="button"  onclick="downExcel();" value="下载编辑模板" class="fontColor"/></a>  -->
...
function downExcel(){
	...
	document.getElementById("btnDownloadUpdate").href="${contextPath}/info/product/export_product_template_update?catCode="+catCode;
	//$("#btnDownloadUpdate").attr("href","${contextPath}/info/product/export_product_template_update?catCode="+catCode);
}
