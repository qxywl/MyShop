...
<div class="pageContent">
	<form method="POST" action="${contextPath}/info/price/add"
			...
			<table class="tablebox">
				...
				<tr>
					...
					<td><input type="text" readonly="readonly"
						...
						<a class="btnLook"
						href="${contextPath}/info/price/selectback"
						lookupGroup="productModel">商品列表</a>
						</td>
				...
				<tr>
					...
					<td>
						<div>
							<input type="text" name="productModel.productId"	 readonly="readonly"							
				...
				<tr>
					...
					<td>
						<div>
							<input type="text" name="productModel.supplierId"	 readonly="readonly"							
								class="validate[required,maxSize[32]] required" size="20"
								maxlength="32" />
						</div>
					</td>
				...
				<tr>
					...
					<td>
						<div>
							<input type="text" name="productModel.productCode"	 readonly="readonly"							
								class="validate[required,maxSize[32]] required" size="20"
								maxlength="32" />
						</div>
					</td>
				...
				<tr>
					...
					<td>
						<div>
							<input type="text" name="productModel.markUpRate"	  readonly="readonly"								
