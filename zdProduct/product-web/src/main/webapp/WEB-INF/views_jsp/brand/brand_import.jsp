...
$(document).ready(function(){
	  $("#btnDownload").click(function(){
		  window.location.href="${contextPath}/brand/downTemplate"; 
	});
});
...
<form method="post" action="${contextPath}/brand/importBrand" enctype="multipart/form-data" onsubmit="return iframeCallback(this, callback)" >
