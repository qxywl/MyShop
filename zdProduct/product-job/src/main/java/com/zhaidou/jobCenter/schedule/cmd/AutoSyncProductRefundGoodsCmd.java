 ...
 *
 */
public class AutoSyncProductRefundGoodsCmd extends Command{

	public static final Log logger = LogFactory.getLog(AutoSyncProductRefundGoodsCmd.class);

	private static final String className = AutoSyncProductRefundGoodsCmd.class.getSimpleName();
	
	@Autowired
	private ProductRefundGoodsManager productRefundGoodsManager;
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productRefundGoodsManager.doJob(condiction);
