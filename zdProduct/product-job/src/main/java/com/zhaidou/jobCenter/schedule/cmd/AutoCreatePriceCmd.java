 ...
 * 
 */
public class AutoCreatePriceCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoCreatePriceCmd.class);

	private static final String className = AutoCreatePriceCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productPriceManager.createJob(condiction);
			return true;
		} catch (Exception e) {
