 ...
 * 
 */
public class AutoOnCreateSaleCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoOnCreateSaleCmd.class);

	private static final String className = AutoOnCreateSaleCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productShelvesManager.createJob(condiction);
			return true;
		} catch (Exception e) {
