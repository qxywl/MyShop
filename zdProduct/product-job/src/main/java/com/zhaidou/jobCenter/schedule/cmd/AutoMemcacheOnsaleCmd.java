 ...
 * 
 */
public class AutoMemcacheOnsaleCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoMemcacheOnsaleCmd.class);

	private static final String className = AutoMemcacheOnsaleCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productShelvesManager.sendMemcache(condiction);
			return true;
		} catch (Exception e) {
