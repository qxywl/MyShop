 ...
 * 
 */
public class AutoGetSupProductCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoGetSupProductCmd.class);

	private static final String className = AutoGetSupProductCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productInfoManager.productToExamine(condiction);
