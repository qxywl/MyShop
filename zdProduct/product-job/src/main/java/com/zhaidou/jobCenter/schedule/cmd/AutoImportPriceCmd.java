 ...
 * 
 */
public class AutoImportPriceCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoImportPriceCmd.class);

	private static final String className = AutoImportPriceCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productPriceManager.imoprt(condiction);
			return true;
		} catch (Exception e) {
