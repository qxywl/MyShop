 ...
 * 
 */
public class AutoSupplierPriceCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoSupplierPriceCmd.class);

	private static final String className = AutoSupplierPriceCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productPriceManager.priceToSupplier(condiction);
			return true;
		} catch (Exception e) {
