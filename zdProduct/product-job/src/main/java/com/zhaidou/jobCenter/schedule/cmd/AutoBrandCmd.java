 ...
 * 
 */
public class AutoBrandCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoBrandCmd.class);

	private static final String className = AutoBrandCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productOtherManager.doJobBrand(condiction);
			return true;
		} catch (Exception e) {
