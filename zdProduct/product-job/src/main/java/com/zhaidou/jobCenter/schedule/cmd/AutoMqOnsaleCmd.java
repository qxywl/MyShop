 ...
 * 
 */
public class AutoMqOnsaleCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoMqOnsaleCmd.class);

	private static final String className = AutoMqOnsaleCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productShelvesManager.sendMq(condiction);
			return true;
		} catch (Exception e) {
