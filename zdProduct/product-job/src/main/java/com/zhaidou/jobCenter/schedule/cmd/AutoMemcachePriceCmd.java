 ...
 * 
 */
public class AutoMemcachePriceCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoMemcachePriceCmd.class);

	private static final String className = AutoMemcachePriceCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productPriceManager.sendMemcache(condiction);
			return true;
		} catch (Exception e) {
