 ...
 * 
 */
public class AutoCreateProductInfoCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoCreateProductInfoCmd.class);

	private static final String className = AutoCreateProductInfoCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productInfoManager.createJob(condiction);
			return true;
		} catch (Exception e) {
