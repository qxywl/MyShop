 ...
 * 
 */
public class AutoViewProductInfoCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoViewProductInfoCmd.class);

	private static final String className = AutoViewProductInfoCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productInfoManager.createView(condiction);
			return true;
		} catch (Exception e) {
