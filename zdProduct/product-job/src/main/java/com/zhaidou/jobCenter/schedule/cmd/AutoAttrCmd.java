 ...
 * 
 */
public class AutoAttrCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoAttrCmd.class);

	private static final String className = AutoAttrCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productOtherManager.doJobAttr(condiction);
			return true;
		} catch (Exception e) {
