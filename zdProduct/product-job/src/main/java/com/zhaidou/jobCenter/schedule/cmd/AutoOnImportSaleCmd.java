 ...
 * 
 */
public class AutoOnImportSaleCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoOnImportSaleCmd.class);

	private static final String className = AutoOnImportSaleCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productShelvesManager.imoprt(condiction);
			return true;
		} catch (Exception e) {
