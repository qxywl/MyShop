 ...
 * 
 */
public class AutoMemcacheProductInfoCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoMemcacheProductInfoCmd.class);

	private static final String className = AutoMemcacheProductInfoCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productInfoManager.sendMemcache(condiction);
			return true;
		} catch (Exception e) {
