 ...
 * 
 */
public class AutoOnsaleCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoOnsaleCmd.class);

	private static final String className = AutoOnsaleCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productShelvesManager.doJob(condiction);
			return true;
		} catch (Exception e) {
