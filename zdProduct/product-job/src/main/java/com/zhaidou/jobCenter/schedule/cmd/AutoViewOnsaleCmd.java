 ...
 * 
 */
public class AutoViewOnsaleCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoViewOnsaleCmd.class);

	private static final String className = AutoViewOnsaleCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productShelvesManager.createView(condiction);
			return true;
		} catch (Exception e) {
