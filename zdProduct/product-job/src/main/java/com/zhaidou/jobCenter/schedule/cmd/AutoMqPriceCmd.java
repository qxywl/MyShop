 ...
 * 
 */
public class AutoMqPriceCmd extends Command {

	public static final Log logger = LogFactory.getLog(AutoMqPriceCmd.class);

	private static final String className = AutoMqPriceCmd.class.getSimpleName();
	...
	public boolean doExecute(HashMap<String, Object> context) {
		...
		try {
			...
			productPriceManager.sendMq(condiction);
			return true;
		} catch (Exception e) {
