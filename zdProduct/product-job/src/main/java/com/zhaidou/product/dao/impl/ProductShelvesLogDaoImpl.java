/*
 * 文 件 名:  ProductShelvesLogDAO.java
 ...
 * @since  [产品/模块版本]
 */
@Repository("productShelvesLogDao")
public class ProductShelvesLogDaoImpl extends BaseDao  implements ProductShelvesLogDao
{
    @Override
    ...
    public void addShelvesLogList(List<ProductShelvesLogModel> shelvesLogList) throws Exception {
        getSqlSession().insert(this.getNameSpace()+".addShelvesLogList",shelvesLogList);
    }
}
