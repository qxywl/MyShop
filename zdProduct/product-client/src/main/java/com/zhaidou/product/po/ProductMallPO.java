...
public class ProductMallPO implements Serializable{
	
	   
	
	private static final long serialVersionUID = 2414554129043088540L;
    ...
    private String productShelves;//商品上下架状态
    ...
    private String type;//业务类型 类型 01:商城;02:机票;03:酒店;04:鲜花;05:团购
    ...
    private int productDownShow;//是否下架显示 1是 2否
   
    private int productAutoUp;//是否自动上架 1是 2否
    ...
    private double productPriceRate;//浮动比例
    ...
    private List<ProductMallSkuPO> skuPOList; //sku集合 
	...
	public int getProductDownShow() {
		return productDownShow;
	}

	public void setProductDownShow(int productDownShow) {
		this.productDownShow = productDownShow;
	}

	public int getProductAutoUp() {
		return productAutoUp;
	}

	public void setProductAutoUp(int productAutoUp) {
	...
	public List<ProductMallSkuPO> getSkuPOList() {
		return skuPOList;
	}

	public void setSkuPOList(List<ProductMallSkuPO> skuPOList) {
