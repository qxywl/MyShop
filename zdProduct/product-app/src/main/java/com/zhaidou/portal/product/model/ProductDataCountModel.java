package com.zhaidou.portal.product.model;
...
//@CacheModelIndexAnnotation("businessType,productId,countType")
public class ProductDataCountModel implements Serializable{
    ...
    /** 统计的数据类型,如10浏览量，20收藏统计数，30加入购物车统计数，40下单统计数，50销量，60评论统计数，70点赞统计数等 */
    ...
    public ProductDataCountModel() {
    }
    public ProductDataCountModel(String businessType, String productId, String countType) {
    ...
    public String toString() {
        return "ProductDataCountModel [id=" + id + ", businessType=" + businessType + ", productId=" + productId
                ...
                + ", updatedTime=" + updatedTime + ", isDelete=" + isDelete + "]";
    }
