 ...
 * @since  [产品/模块版本]
 */
public interface ProductInfoDao extends IDao
{
    /**
     * 根据productId 获取supplierModel
     * @param supplierModel
     * @return
     */
    public ProductInfoModel getProInfoByProductId(ProductInfoModel productInfoModel) throws Exception ;
